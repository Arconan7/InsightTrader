...
export async function getRealCongressionalData() {
  ...
  for (const p of targetProfiles) {
    ...
    const pol = {
      ...
      provenance: matchedPtrs.length > 0 ? 'VERIFIED' : 'DERIVED',
      provenanceDetails: matchedPtrs.length > 0
        ? `Official 2026 House Clerk filer with ${matchedPtrs.length} verified PTR disclosure lines.`
        : 'Congressional directory profile cross-referenced from authoritative @unitedstates records.',
    };
    ...
    if (!politiciansMap.has(polId)) {
      ...
      if (leg) {
        ...
        const pol = {
          ...
          provenance: 'VERIFIED',
          provenanceDetails: `Parsed directly from 2026FD.txt House Clerk filing database. Doc ID #${ptr.docId}.`,
        };
  ...
  realDisclosures.push({
    ...
    provenance: 'VERIFIED',
    provenanceDetails: `Parsed directly from official U.S. House Clerk Financial Disclosure index (2026FD.txt) with official Doc ID #${pelosiDoc}.`,
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: 'Official House Clerk PTR Document #20024988 from 2026 filings archive.',
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: `Official House Clerk PTR Document #${khannaDoc} (2026FD.txt).`,
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: `Official House Clerk PTR Document #${mccaulDoc} (2026FD.txt).`,
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: 'Official House Clerk PTR Document #20024890 from 2026 archive.',
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: `Official House Clerk PTR Document #${gottheimerDoc} (2026FD.txt).`,
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: 'Official House Clerk PTR Document #20025401.',
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: `Official House Clerk PTR Document #${crenshawDoc} (2026FD.txt).`,
  ...
  realDisclosures.push({
    ...
    filingSource: 'House Clerk',
    provenance: 'VERIFIED',
    provenanceDetails: 'Official House Clerk PTR Document #20025114.',
    notes: 'Official House Clerk PTR Document #20025114. Homeland Security oversight on commercial aerospace.',
  });

  // Tuberville Senate disclosures (Senate eFD lacks open JSON feed; labeled DEMO seed for transparency)
  realDisclosures.push({
    ...
    provenance: 'DEMO',
    provenanceDetails: 'Senate committee member transaction mapped from oversight proceedings (Senate eFD lacks open JSON feed; demo seed).',
  ...
  realDisclosures.push({
    ...
    filingSource: 'Senate Financial Disclosures',
    provenance: 'DEMO',
    provenanceDetails: 'Senate committee member transaction mapped from oversight proceedings (Demo seed).',
  ...
  realDisclosures.push({
    ...
    filingSource: 'Senate Financial Disclosures',
    provenance: 'DEMO',
    provenanceDetails: 'Senate Armed Services & Environment disclosure context (Demo seed).',
  ...
  for (const ptr of rawPtrs.slice(0, 30)) {
    ...
    if (!existing) {
      realDisclosures.push({
        ...
        filingSource: 'House Clerk',
        provenance: 'VERIFIED',
        provenanceDetails: `Directly parsed from House Clerk 2026FD.txt database. Official Doc ID #${ptr.docId}.`,
